...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Api\\RecipeController' => 'getRecipeControllerService',
            'App\\Controller\\Api\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\Api\\UpVoteController' => 'getUpVoteControllerService',
            'App\\Controller\\Api\\UserController' => 'getUserControllerService',
            'App\\Manager\\SecurityManager' => 'getSecurityManagerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Api\\RecipeController', 'App\\Controller\\Api\\SecurityController', 'App\\Controller\\Api\\UpVoteController', 'App\\Controller\\Api\\UserController', 'App\\Manager\\SecurityManager', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('yB0x1BOw1a', 0, $container->getParameter('container.build_id'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6Je+eZxrrA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dFHckU2tOY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $d = new \Symfony\Component\PropertyInfo\PropertyInfoCacheExtractor(new \Symfony\Component\PropertyInfo\PropertyInfoExtractor(new RewindableGenerator(function () use ($container) {
